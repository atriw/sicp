...
(define (setup-environment env-model)
  (define the-empty-environment (env-model 'the-empty-environment))
  (define extend-environment (env-model 'extend-environment))
  (define define-variable! (env-model 'define-variable!))
